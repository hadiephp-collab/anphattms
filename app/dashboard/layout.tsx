...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: '/dashboard/employees', label: 'Nhân Viên', exact: false,
  ...
  },
  {
    ...
    items: [
      {
        href: '/dashboard/branches', label: 'Chi Nhánh', exact: false,
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: '/dashboard/cai-dat/vai-tro', label: 'Cài Đặt', exact: false,
        ...
        children: [
          { href: '/dashboard/cai-dat/chung', label: 'Cài Đặt Chung' },
          { href: '/dashboard/cai-dat/vai-tro', label: 'Vai Trò & Quyền', exact: false },
          { href: '/dashboard/cai-dat/tai-khoan-nh', label: 'Tài Khoản NH' },
        ],
      },
      {
