  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          { href: '/dashboard/cai-dat/chung', label: 'Cài Đặt Chung', exact: false },
          { href: '/dashboard/cai-dat/vai-tro', label: 'Vai Trò & Quyền', exact: false },
          { href: '/dashboard/cai-dat/tai-khoan-nh', label: 'Tài Khoản NH', exact: false },
          { href: '/dashboard/cai-dat/mau-in', label: 'Mẫu In', exact: false },
        ],
      },
      {
