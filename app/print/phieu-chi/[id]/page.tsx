...
export default function PrintPhieuChiPage() {
  ...
  if (!tx) return <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', fontFamily: 'Arial', color: '#f00', fontSize: 14 }}>Không tìm thấy phiếu chi</div>;
      ...
      <div style={{ maxWidth: 680, margin: '0 auto', padding: '52px 0 32px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16, borderBottom: '2px solid #000', paddingBottom: 10 }}>
          ...
          <div style={{ textAlign: 'right' }}>
            <div style={{ fontSize: 17, fontWeight: 700, textTransform: 'uppercase', letterSpacing: 1 }}>Phiếu Chi</div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: 16, fontSize: 12 }}>
          <tbody>
            <tr>
              <td style={{ padding: '4px 0', color: '#555', width: 160, verticalAlign: 'top' }}>Người nhận tiền:</td>
              <td style={{ padding: '4px 0', fontWeight: 600 }}>{tx.partner?.name || '—'}</td>
            </tr>
            <tr>
              <td style={{ padding: '4px 0', color: '#555', verticalAlign: 'top' }}>Lý do chi:</td>
        ...
        <div style={{ border: '1px solid #000', borderRadius: 4, padding: '14px 16px', marginBottom: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ fontSize: 13, fontWeight: 600 }}>SỐ TIỀN CHI:</div>
          <div style={{ fontSize: 22, fontWeight: 700, color: '#dc2626' }}>{fmt(Number(tx.amount))}</div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16, marginTop: 20, textAlign: 'center', fontSize: 12 }}>
          <div>
            <div style={{ fontWeight: 600, marginBottom: 4 }}>Người nhận</div>
